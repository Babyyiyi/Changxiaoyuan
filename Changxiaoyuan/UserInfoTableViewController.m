...
- (void)viewDidLoad
{
    ...
    UINavigationBar *navigationBar = [[UINavigationBar alloc] initWithFrame:CGRectMake(0, 20, 320, 40)];
    UIBarButtonItem *quitItem = [[UIBarButtonItem alloc] initWithTitle:@"注销"
                                                                 style:UIBarButtonItemStyleDone
                                                                target:self
                                                                action:@selector(quit)];
    navigationBar.items = @[quitItem];
}
